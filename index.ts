  ...
  do {
    ...
    if (myOptions.Options === "Withdraw amount") {
      ...
      if (Withdraw.Amount < myBalance) {
        console.log(
          `Your remaining Balance is: ${myBalance - Withdraw.Amount}`
        );
      } else {
      ...
      if (depositAmount.Deposite_Amount <= myBalance) {
        console.log(
          `Your remaining balance is:${
            myBalance - depositAmount.Deposite_Amount
          }`
        );
      } else {
      ...
      if (Fast_Cash.Fast_cash_amount < myBalance) {
        console.log(
          `Your remaining balance is: ${myBalance - Fast_Cash.Fast_cash_amount}`
        );
      }
    }
